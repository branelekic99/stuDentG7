...
const Profile = ({navigation}) => {
    ...
    const {height:highOfDeviceScreen,width:widthOfDeviceScreen} = Dimensions.get("window");
    ...
    console.log(highOfDeviceScreen);
    return (
            <View style={styles.container}>
                <ScrollView contentContainerStyle={{flexGrow:1,width:widthOfDeviceScreen,alignItems:"center"}}>
